    ...
    <div class="content-wrapper p-2" style="min-height: 339.816px;">
        ...
        <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                            <h1 class="m-0">Création d'un enseignant</h1>
                            </div>
        ...
        <div class="card card-success">
            <form action="{{url('admin/enseignant/creer')}}" method="post" enctype="multipart/form-data">
                  {{@csrf_field()}}
                <div class="card-body">
                   <div class="row">
                   ...
                   <div class="row">
                    <div class="form-group col-sm-6">
                       ...
                       <input type="text" class="form-control" name="phone" placeholder="votre telephone..." required>
                   </div>
                   <div class="form-group col-sm-6">
                       <label >Telephone 2: </label>
                       <input type="text" class="form-control"  name = "phone2" placeholder="votre telephone...">
                   </div>
              </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
