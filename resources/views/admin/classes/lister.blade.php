                                    ...
                                    <tbody>
                                      @foreach ($classes as $key=>$classe)
                                            ...
                                            <td class="text-center">
                                                <a href="{{url('admin/classe/modifier/'.$classe->id)}}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="{{url('admin/classe/supprimer/'.$classe->id)}}" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                        </tr>
                                      @endforeach
